...
#include <stdint.h>
#include <stdbool.h>
// PLACE ORDER = IDLE > ROTATE_DOCK > MOVE_UP_DOCK > PICKUP > MAGNET_ON > MOVE_UP_DOCK > STILL >> wait > ROTATE_BOARD > MOVE_UP_BOARD > BOAT_ROTATE > PLACEMENT > MAGNET_OFF > WAIT > MOVE_UP_BOARD > STILL > ROTATE_DOCK > RETURN
