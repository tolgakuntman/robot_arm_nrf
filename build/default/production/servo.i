...
# 10 "/opt/microchip/xc8/v2.50/pic/include/c99/stdlib.h" 3
...
# 50 "./mcc_generated_files/timer/timer_interface.h"
...
# 1 "./mcc_generated_files/timer/tmr1_deprecated.h" 1
...
void initServo() {
    ...
    servos[0].nextAngle = calculateAngle(43);
    ...
    servos[3].nextAngle = calculateAngle(45);
}
