...
const GridPosition grid_angles[5][5] = {
    { { {23, 110, 161, 37}, 70, 70}, { {30, 110, 153, 48}, 110, 110},
      { {44, 110, 148, 65}, 110, 110}, { {59, 110, 148, 79}, 150, 51},
      { {78, 60, 144, 95}, 147, 49} },

    { { {18, 110, 144, 29}, 50, 50}, { {30, 110, 142, 48}, 147, 50},
      { {40, 110, 138, 60}, 110, 110}, { {56, 110, 138, 77}, 140, 40},
      { {72, 34, 135, 90}, 140, 40} },

    { { {18, 110, 125, 30}, 32, 32}, { {26, 110, 125, 43}, 110, 110},
      { {38, 110, 126, 58}, 110, 110}, { {56, 110, 128, 78}, 133, 30},
      { {72, 28, 127, 92}, 132, 28} },

    { { {21, 110, 104, 35}, 9, 9}, { {30, 110, 110, 48}, 110, 110},
      { {40, 110, 114, 60}, 110, 50}, { {56, 110, 117, 77}, 125, 23},
      { {73, 173, 118, 91}, 123, 23} },

    { { {26, 110, 87, 43}, 105, 9}, { {34, 110, 96, 55}, 105, 105},
      { {46, 110, 102, 67}, 110, 110}, { {60, 110, 107, 80}, 111, 111},
      { {80, 173, 108, 94}, 110, 110} },
};

const GridPosition grid_angles_up[5][5] = {
    { { {30, 110, 161, 30}, 70, 70}, { {40, 110, 153, 40}, 110, 110},
      { {50, 110, 148, 60}, 110, 110}, { {60, 110, 148, 70}, 150, 51},
      { {85, 60, 144, 80}, 147, 49} },

    { { {20, 110, 144, 20}, 50, 50}, { {35, 110, 142, 35}, 147, 50},
      { {50, 110, 138, 50}, 110, 110}, { {60, 110, 138, 70}, 140, 40},
      { {80, 34, 135, 80}, 140, 40} },

    { { {30, 110, 125, 20}, 32, 32}, { {30, 110, 128, 30}, 110, 110},
      { {40, 110, 126, 50}, 110, 110}, { {60, 110, 128, 70}, 133, 30},
      { {80, 28, 127, 80}, 132, 28} },

    { { {30, 110, 104, 30}, 9, 9}, { {40, 110, 110, 40}, 110, 110},
      { {50, 110, 114, 50}, 110, 110}, { {60, 110, 117, 70}, 125, 23},
